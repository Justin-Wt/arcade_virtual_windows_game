...
class game(arcade.View):
    def __init__(self):
        ...
        self.text=[
            (
            (("Press   or   to move around",359.446,339,(255,255,255),15.107),("A    D",446.167,339,(0,85,255),415.107)),
            (("Click       to jump",13.2053,315.911,(255,255,255),393.421),("space",107.0,315.5,(85,255,255),141.5)),
            (("looks like your path is",267.906882591,566.352226721,(255,255,255),472.262483131),("blocked, hold      to",267.906882591,526.352226721,(255,255,255),472.262483131),("climb the ladder",267.906882591,486.352226721,(255,255,255),472.262483131),("space",465.868666667,526.548833333,(85, 255, 255),105.596))
            ),
            (
        ...
        self.Button=None
        self.level=[
            ["assets/levels/level1.1.tmj","assets/levels/level1.2.tmj","assets/levels/level1.3.tmj"],
            ["assets/levels/level2.1.tmj","assets/levels/level2.2.tmj","assets/levels/level2.3.tmj"],
            ["assets/levels/level3.1.tmj","assets/levels/level3.2.tmj","assets/levels/level3.3.tmj"],
            ["assets/levels/death_mode1.5.tmj","assets/levels/death_mode1.2.tmj","assets/levels/death_mode1.3.tmj","assets/levels/death_mode1.4.tmj","assets/levels/death_mode1.5.tmj"]
        ]
    ...
    def setup(self):
        ...
        self.tilemap=arcade.load_tilemap(self.level[self.current_level-1][self.level_progress-1],layer_options={ "ground": {"use_spatial_hash": True}})
        ...
        self.title=arcade.Text(f"level {self.current_level}",self.screen_width//2-70,self.screen_height-40,arcade.color.WHITE,40)
        self.in_level=True
    ...
    def on_draw(self):
        ...
        if self.in_level:
            ...
            for i in range(self.life):
                arcade.draw_texture_rect(self.hp_sprite,arcade.XYWH(85+35*i, height-20, 30, 30))
            self.life_text.draw()
        else:
    ...
    def on_update(self, delta_time):
        if self.in_level:
            ...
            if arcade.check_for_collision_with_list(self.player,self.obstacle):
                ...
                self.setup()
            coin_hit_list= arcade.check_for_collision_with_list(self.player,self.coinlist)
    ...
    def on_key_release(self, key, modifiers):
        ...
        if key in (arcade.key.LEFT,arcade.key.RIGHT,arcade.key.A,arcade.key.D):
            ...
            self.left_pressed=False
        if self.can_climb:
            if key in(arcade.key.SPACE,arcade.key.W,arcade.key.S,arcade.key.UP,arcade.key.DOWN):
